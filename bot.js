...
const activities_list = [
        ".yardım + 3 sunucu + 503 kullanıcı 🔥",
        ".canlıdestek Yetkili ekibimiz gerekeni yapar..",
        ".davet Komutunu Kullanarak Botu Davet Edebilirsiniz :)",
        "https://trexbot.glitch.me/"
    ]; 
...
client.on("message", async message => {
    let sayac = JSON.parse(fs.readFileSync("./sunucuyaözelayarlar/sayac.json", "utf8"));
    if(sayac[message.guild.id]) {
        if(sayac[message.guild.id].sayi <= message.guild.members.size) {
            ...
            fs.writeFile("./sunucuyaözelayarlar/sayac.json", JSON.stringify(sayac), (err) => {
                console.log(err)
            })
        }
    }
...
fs.writeFile('./xp.json', JSON.stringify(points), (err) => {
  ...
  if (message.content.toLowerCase() === prefix + 'level' || message.content.toLowerCase() === prefix + 'rank') {

const level = new Discord.RichEmbed().setTitle(`${user.username} | TrexBot`).setDescription(`**Seviye:**\n ${userData.level}\n**EXP:** \n${userData.points} \n`).setColor("RANDOM").setFooter(``).setThumbnail(user.avatarURL)
.setTimestamp()
.setFooter('TrexBot Level Sistemi 🎓', user.avatarURL)
...
client.on('message', async msg => {
    ...
    .setTitle(':warning: | İlk olarak sesli bir kanala giriş yapmanız gerek.'));
      ...
      .setTitle(`**✅ | Oynatma Listesi: **${playlist.title}** Kuyruğa Eklendi!**`)
         ...
         .setTitle('Trex Bot | Şarkı Seçimi')
   ...
   .setTitle(`:warning: Şuanki Ses Seviyesi: **${serverQueue.volume}**`)
    ...
    .setColor('RANDOM'));
		  return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setColor('RANDOM')
     .setTitle('Trex Bot | Şarkı Kuyruğu')
...
function play(guild, song) {
  ...
  .setTitle("**Trex | 🎙 Müzik Başladı**",`https://cdn.discordapp.com/avatars/473974675194511361/6bb90de9efe9fb80081b185266bb94a6.png?size=2048`)
